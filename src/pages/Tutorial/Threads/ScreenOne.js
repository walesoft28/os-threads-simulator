    ...
    <Bounce>
      <div className={classes.heroContent}>
        <Container maxWidth="sm">
          ...
          {/* A Thread consists of a thread ID, a
          program counter that keeps track of which instruction to execute next,
          a register set which hold it's current working variables and a stack
          ...
          <Typography
            ...
            paragraph
          >
            A thread is popularly described as a lightweight process, it is a
